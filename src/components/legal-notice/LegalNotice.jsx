            ...
            <div className="terms-container">
                ...
                <div id="terms-eng">
                    <div className="terms-box">
                        ...
                        <h1 className="terms-title">Legal Notice</h1>
                        <ButtonHome/>
                    </div>
                </div>
                ...
                <p>
                    ...
                    Email:
                    <a className="terms-link" href='mailto:bogdan.grabinskij@gmail.com'>
                ...
                <h2 className="terms-h2">Purpose and Use</h2>
                <p>Our pages are designed and operated as hobby websites. Our pages are
                ...
                <h2 className="terms-h2">Liability for Content</h2>
                <p>While we have made every effort to ensure the accuracy, completeness,
                ...
                <h2 className="terms-h2">Liability for Links</h2>
                <p>Our pages may contain links to third-party external websites whose
                ...
                <h2 className="terms-h2">Copyright</h2>
                <p>The content and works created by the website operators are subject to
                ...
                <p>If the content on this page was not created by the operator, the
                ...
                <h5>GitHub:</h5>
                <a className="terms-link" href='https://github.com/grabinskij' target="_blank"
                   rel="noopener noreferrer">https://github.com/grabinskij</a>

                <h5>LinkedIn:</h5>
                <a className="terms-link" href='https://www.linkedin.com/in/bohdan-hrabynskyi'
                   target="_blank" rel="noopener noreferrer">https://www.linkedin.com/in/bohdan-hrabynskyi</a>

                <h5>Facebook:</h5>
                <a className="terms-link" href='https://www.facebook.com/bogdan.grabinsky'
                   target="_blank" rel="noopener noreferrer">https://www.facebook.com/bogdan.grabinsky</a>
                ...
                <div id="terms-de">
                    <div className="terms-box">
                        ...
                        <h1 className="terms-title">Impressum</h1>
                        <ButtonHome/>
                    </div>
                </div>
                ...
                <h2 className="terms-h2">Zweck und Verwendung</h2>
                <p>Unsere Seiten sind als Hobby-Websites konzipiert und wird betrieben.
                ...
                <h2 className="terms-h2">Haftung für Inhalte</h2>
                <p>Unsere Inhalte wurden mit großer Sorgfalt erstellt, jedoch können wir
                ...
                <h2 className="terms-h2">Haftung für Links</h2>
                <p>Unsere Seiten können Links zu externen Websites Dritter enthalten,
                ...
                <h2 className="terms-h2">Urheberrecht</h2>
                <p>Die Inhalte und Werke, die durch die Seitenbetreiber erstellt wurden,
                    unterliegen dem
                ...
                <p>Sofern die Inhalte auf dieser Seite nicht vom Betreiber erstellt
                    wurden, werden die
