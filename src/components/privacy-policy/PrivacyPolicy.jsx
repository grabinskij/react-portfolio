    ...
    return (
        <div className="terms-body">
            <div className="terms-container">
                    ...
                    <div className="terms-box">
                        <div className="terms-box__button-wrapper">
                            <div className="terms-box__button">
                                <button><a href='#terms-de' className="btn">DE</a></button>
                            </div>
                            <div className="terms-box__button">
                                <button><a href='#terms-eng' className="btn">ENG</a></button>
                            </div>
                        </div>
                ...
                <h2 className="terms-h2">General Information</h2>
                ...
                <h2 className="terms-h2">Data Collection on This Website</h2>
                ...
                <h1 className="terms-title">Hosting</h1>
                ...
                <h1 className="terms-title">Mandatory Information</h1>
                ...
                <h2 className="terms-h2">Right to Data Portability</h2>
                ...
                <h2 className="terms-h2">Information, Correction, and Deletion</h2>
                ...
                <h2 className="terms-h2">Right to Restrict Processing</h2>
                ...
                <h1 className="terms-title">Data Collection on This Website</h1>

                <h2 className="terms-h2">Cookies</h2>
                ...
                <h2 className="terms-h2">Contact Form</h2>
                ...
                <h2 className="terms-h2">Comment Function on This Website</h2>
                ...
                <h1 className="terms-title">Additional Features and Tools</h1>


                <h2 className="terms-h2">Google Fonts</h2>
                ...
                <p>Further information about Google Fonts can be found in Google&apos;s privacy policy at:
                    <a className="terms-link" href="https://policies.google.com/privacy?hl=en"
                       target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy?hl=en</a>
                </p><br/>

                <h2 className="terms-h2">Font Awesome</h2>
                ...
                <p>For more information on Font Awesome, please see Font Awesome&apos;s Privacy Policy at:
                    <a className="terms-link" href="https://fontawesome.com/privacy" target="_blank"
                       rel="noopener noreferrer">https://fontawesome.com/privacy</a>
                </p><br/>

                <h2 className="terms-h2">Google Maps</h2>
                ...
                <p>For more details, please see:
                    <a className="terms-link" href="https://privacy.google.com/businesses/gdprcontrollerterms/" target="_blank"
                       rel="noopener noreferrer">https://privacy.google.com/businesses/gdprcontrollerterms/
                    </a>
                    <a className="terms-link" href="https://privacy.google.com/businesses/gdprcontrollerterms/sccs/" target="_blank"
                ...
                <p>For more information on how Google handles user data, please see Google&apos;s Privacy Policy at:
                    <a className="terms-link" href="https://policies.google.com/privacy?hl=en" target="_blank"
                       rel="noopener noreferrer">https://policies.google.com/privacy?hl=en</a>
                </p><br/>

                <h2 className="terms-h2">Bootstrap Framework (via jsDelivr CDN)</h2>
                ...
                <p>The provider&apos;s privacy policy for jsDelivr can be found at:
                    <a className="terms-link" href="https://www.jsdelivr.com/privacy-policy-jsdelivr-net/"
                       target="_blank"
                       rel="noopener noreferrer">https://www.jsdelivr.com/privacy-policy-jsdelivr-net</a>
                </p><br/><br/>

                <h2 className="terms-h2">jQuery</h2>
                ...
                <p>For more information on how Google handles user data, please see Google&apos;s Privacy Policy at:
                    <a className="terms-link" href="https://www.google.com/policies/privacy"
                       target="_blank" rel="noopener noreferrer">https://www.google.com/policies/privacy</a>
                </p><br/><br/>


                <h1 className="terms-title">Authentication</h1>

                <h2 className="terms-h2">Use of Firebase Authentication</h2>
                ...
                <p>For more information on data protection, please refer to Google&apos;s Privacy Policy at:
                    <a className="terms-link" href="https://policies.google.com/privacy"
                       target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy</a>
                </p><br/>

                <h2 className="terms-h2">Google OAuth</h2>
                ...
                <h2 className="terms-h2">jsDelivr CDN</h2>
                ...
                <h2 className="terms-h2">Allgemeine Hinweise</h2>
                ...
                <h2 className="terms-h2">Datenerfassung auf dieser Website</h2>
                ...
                <h1 className="terms-title">Pflichtinformationen</h1>
                ...
                <h2 className="terms-h2">Recht auf Datenübertragbarkeit</h2>
                ...
                <h2 className="terms-h2">Auskunft, Korrektur und Löschung</h2>
                ...
                <h2 className="terms-h2">Recht auf Beschränkung der Datenverarbeitung</h2>
                ...
                <h1 className="terms-title">Datenerfassung auf dieser Website</h1>
                ...
                <h2 className="terms-h2">Kontaktformular</h2>
                ...
                <h2 className="terms-h2">Kommentarfunktion auf dieser Website</h2>
                ...
                <h1 className="terms-title">Zusatzfunktionen und Tools</h1>
                ...
                <p>Weitere Informationen zu Google Fonts finden Sie unter der Datenschutzerklärung von Google
                    unter:
                    <a className="terms-link" href="https://policies.google.com/privacy?hl=de"
                ...
                <p>Weitere Informationen zu Font Awesome finden Sie in der Datenschutzerklärung von Font Awesome
                    unter:
                    <a className="terms-link" href="https://fontawesome.com/privacy"
                ...
                <p>Weitere Informationen zum Umgang mit Nutzerdaten finden Sie in der Datenschutzerklärung von
                    Google:
                    <a className="terms-link" href="https://policies.google.com/privacy?hl=de" target="_blank"
                ...
                <h1 className="terms-title">Authentifizierung</h1>

                <h2 className="terms-h2">Nutzung von Firebase Authentication</h2>
